...
class EmployeeSystem:
    def __init__(self,root):
        ...
        btn_emp=Button(self.root,text="All Employee's",command=self.employee_frame,font=("times new roman",13,),bg="gray",fg="white").place(x=1100,y=10,height=28,width=120)
        #=========Frame1=========
        #=========Frame1 Variables=======
        ...
        btn_search=Button(Frame1,text="Search",command=self.search,font=("times new roman",20,),bg="gray",fg="black").place(x=422,y=72,height=28)
        #========Row1========
        ...
        lbl_Experience=Label(Frame1,text="Experience:",font=("times new roman",20,),bg="white",fg="black").place(x=385,y=220)
        ...
        txt_proof_id=Entry(Frame1,font=("times new roman",15,),textvariable=self.var_proof_id,bg="lightyellow",fg="black").place(x=520,y=275)
        #========Row5========
        ...
        lbl_Contact_Numbr=Label(Frame1,text="ContactNo",font=("times new roman",20,),bg="white",fg="black").place(x=390,y=320)
        txt_Contact_Numbr=Entry(Frame1,font=("times new roman",15,),textvariable=self.var_contact,bg="lightyellow",fg="black").place(x=520,y=325)
         #========Row6========
        ...
        lbl_mnth=Label(Frame2,text="Month",font=("times new roman",18,),bg="white",fg="black").place(x=10,y=60)
        txt_mnth=Entry(Frame2,font=("times new roman",15,),textvariable=self.var_month,bg="lightyellow",fg="black").place(x=90,y=62,width=100)
        ...
        #========Row1========
        lbl_total_days=Label(Frame2,text="Total Days",font=("times new roman",18,),bg="white",fg="black").place(x=10,y=120)
        txt_total_days=Entry(Frame2,font=("times new roman",15,),textvariable=self.var_t_days,bg="lightyellow",fg="black").place(x=170,y=125,width=100)
        ...
        btn_calculate=Button(Frame2,text="Calculate",command=self.calculate,font=("times new roman",20,),bg="orange",fg="black").place(x=150,y=225,height=28,width=120)
        self.btn_save=Button(Frame2,text="Save",command=self.add,font=("times new roman",20,),bg="green",fg="white")
        self.btn_save.place(x=285,y=225,height=28,width=120)
        btn_clear=Button(Frame2,text="Clear",command=self.clear,font=("times new roman",20,),bg="gray",fg="black").place(x=420,y=225,height=28,width=120)
        ...
        txt_Result=Entry(Cal_Frame,font=("times new roman",20,"bold"),bg="lightyellow",textvariable=self.var_txt,justify=RIGHT)
        txt_Result.place(x=0,y=0,relwidth=1,height=51)
        
        
        #========Row1=========
        btn_7=Button(Cal_Frame,text="7",command=lambda:btn_click(7),font=("times new roman",15,"bold")).place(x=0,y=53,width=60,height=60)
        btn_8=Button(Cal_Frame,text="8",command=lambda:btn_click(8),font=("times new roman",15,"bold")).place(x=61,y=53,width=60,height=60)
        btn_9=Button(Cal_Frame,text="9",command=lambda:btn_click(9),font=("times new roman",15,"bold")).place(x=122,y=53,width=60,height=60)
        btn_div=Button(Cal_Frame,text="/",command=lambda:btn_click('/'),font=("times new roman",15,"bold")).place(x=183,y=53,width=60,height=60)
        #========Row2=========
        btn_4=Button(Cal_Frame,text="4",command=lambda:btn_click(4),font=("times new roman",15,"bold")).place(x=0,y=113,width=60,height=60)
        btn_5=Button(Cal_Frame,text="5",command=lambda:btn_click(5),font=("times new roman",15,"bold")).place(x=61,y=113,width=60,height=60)
        btn_6=Button(Cal_Frame,text="6",command=lambda:btn_click(6),font=("times new roman",15,"bold")).place(x=122,y=113,width=60,height=60)
        btn_mul=Button(Cal_Frame,text="*",command=lambda:btn_click('*'),font=("times new roman",15,"bold")).place(x=183,y=113,width=60,height=60)
        #========Row3=========
        btn_1=Button(Cal_Frame,text="1",command=lambda:btn_click(1),font=("times new roman",15,"bold")).place(x=0,y=173,width=60,height=60)
        btn_2=Button(Cal_Frame,text="2",command=lambda:btn_click(2),font=("times new roman",15,"bold")).place(x=61,y=173,width=60,height=60)
        btn_3=Button(Cal_Frame,text="3",command=lambda:btn_click(3),font=("times new roman",15,"bold")).place(x=122,y=173,width=60,height=60)
        btn_add=Button(Cal_Frame,text="+",command=lambda:btn_click('+'),font=("times new roman",15,"bold")).place(x=183,y=173,width=60,height=60)
        #========Row4=========
        btn_0=Button(Cal_Frame,text="0",command=lambda:btn_click(0),font=("times new roman",15,"bold")).place(x=0,y=234,width=60,height=60)
        btn_pnt=Button(Cal_Frame,text="C",command=clear_cal,font=("times new roman",15,"bold")).place(x=61,y=234,width=60,height=60)
        btn_sub=Button(Cal_Frame,text="-",command=lambda:btn_click('-'),font=("times new roman",15,"bold")).place(x=122,y=234,width=60,height=60)
        btn_eql=Button(Cal_Frame,text="=",command=result,font=("times new roman",15,"bold")).place(x=183,y=234,width=60,height=60)
        #=======Salary Frame=======
        ...
        if self.var_emp_code.get()=='' or self.var_net_salary.get()=='' or self.var_name.get()=='':
            ...
            try:
                ...
                if row==None:
                    ...
                    cur.execute("UPDATE emp_salary SET designation=%s,name=%s,age=%s,gender=%s,email=%s,hr_location=%s,doj=%s,dob=%s,experience=%s,proof_id=%s,contact=%s,status=%s,address=%s,month=%s,year=%s,basic_salary=%s,t_days=%s,absent=%s,medical=%s,pf=%s,convence=%s,net_salary=%s,salary_receipt=%s WHERE emp_code=%s",
                               (
                    ...
                    file_.close()
                    messagebox.showinfo("Succes","Record Updated Succesfully")
            except Exception as ex:
                messagebox.showerror("Error",f'Error due to: {str(ex)}')
        ...
        if self.var_emp_code.get()=='' or self.var_net_salary.get()=='' or self.var_name.get()=='':
            ...
            try:
                ...
                if row!=None:
                    ...
                    file_.write(self.txt_salary_receipt.get('1.0',END))
                    file_.close()
                    messagebox.showinfo("Succes","Record Added Succesfully")
                    self.btn_print.config(state=NORMAL)
            except Exception as ex:
                messagebox.showerror("Error",f'Error due to: {str(ex)}')
...
------------------------------------------------
 ...
 Total Present\t\t:  {int(self.var_t_days.get())-int(self.var_absent.get())}
...
------------------------------------------------
 ...
 '''
    ...
    def  employee_frame(self):
        ...
        self.employee_tree=ttk.Treeview(self.root2,columns=('emp_code','designation','name','age','gender','email','hr_location','doj','dob','experience','proof_id','contact','status','address','month','year','basic_salary','t_days','absent','medical','pf','convence','net_salary','salary_receipt'),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.employee_tree.column('convence',width=200)
